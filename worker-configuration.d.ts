/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 03a542d320005bff8f3f5a06e519f954)
...
declare namespace Cloudflare {
	interface DevEnv {
		...
		CONTACT_DEV_EMAIL: string;
		CONTACT_ENV: string;
		CONTACT_FORM_EMAILS_BASE64: string;
		PUBLIC_ENABLE_SW_DEV: string;
