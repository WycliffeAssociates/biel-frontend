    ...
    <>
      <Show when={!props.isSearchPage}>
        ...
        >
          <input
            class={
              "border border-surface-border! p-4  rounded-2xl bg-surface-primary!  placeholder:(text-onSurface-tertiary font-italic) w-full"
            }
            onFocus={() => {
...
function SearchAsPage(props: SearchAsPageProps) {
  ...
  return (
    <div
      class="pbs-8 relative grid-col-[inherit] contain-pad"
      data-js={constants.searchAsPageQuerySelector}
    >
      <div class="relative">
        <input
