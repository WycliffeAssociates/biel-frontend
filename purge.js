...
async function purgeAgainstAdditionalGlobals() {
	...
	// todo: default extractor doesn't consider @, :, and /, so it isn't picking up stuff like md:block in server routes.  Just ignore this add'l globals route for now and only purge inline styles from wp
